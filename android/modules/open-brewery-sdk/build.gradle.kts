    ...
    android {
        namespace = "com.multiplatformbusinesssdk.openbrewery"
        compileSdk = 34
    ...
    publishing {
        publications {
            create("release", org.gradle.api.publish.maven.MavenPublication::class) {
                ...
                artifactId = "open-brewery-sdk-android"
                version = System.getenv("SDK_VERSION") ?: "0.1.0-SNAPSHOT"

                pom {
                    name.set("OpenBrewerySDK Android")
                    description.set("Generated Android business SDK for OpenBrewerySDK.")
                }
            }
        }
