    ...
    android {
        namespace = "com.multiplatformbusinesssdk.adviceslip"
        compileSdk = 34
    ...
    publishing {
        publications {
            create("release", org.gradle.api.publish.maven.MavenPublication::class) {
                ...
                artifactId = "advice-slip-sdk-android"
                version = System.getenv("SDK_VERSION") ?: "0.1.0-SNAPSHOT"

                pom {
                    name.set("AdviceSlipSDK Android")
                    description.set("Generated Android business SDK for AdviceSlipSDK.")
                }
            }
        }
